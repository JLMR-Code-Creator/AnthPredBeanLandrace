function  Impl_TrainCNN(pathDB, file, epoch, dirOut, nameOut, colorSpace, channels)
    ...
    if strcmp(colorSpace, 'HSI')==1
        ...
        if channels == 1
            TrainCNNWith1H2DHSI(XTrainHSI, YTrainHSI, XTrainPop, XTrainColor, ...
                XValidationHSI, YValidationHSI, XValidationPop, XValidationColor, ...
                XTestHSI, YTestHSI, XTestPop, XTestColor, epoch, pathDB, dirOut, nameOut);
        else %3 channels
            TrainCNNWith3H2DHSI(XTrainHSI, YTrainHSI, XTrainPop, XTrainColor, ...
                XValidationHSI, YValidationHSI, XValidationPop, XValidationColor, ...
                XTestHSI, YTestHSI, XTestPop, XTestColor, epoch, pathDB, dirOut, nameOut);
        end
