function Plot_CNN_1H_3H_LAB(DBSource, dbfile1, dbfile2)

    D_1H = load(strcat(DBSource,dbfile1),'-mat');
    D_3H = load(strcat(DBSource,dbfile2),'-mat');
    
    YTrue = mean(D_1H.YTrainLAB')';
    ...
    plotAchievedReal(B, sortPredTest_1H, sortPredTest_3H, sortLabelPop, 'CIE L*a*b* color space', '', 'Bean landraces', 'Anthocyanins [mg (C3G) g^{-1}]', 1)
