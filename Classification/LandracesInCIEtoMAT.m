...
% Función creada para guardar la mediana de los valores de los pixeles de
% cada semilla que pertenecen a una población de frijol.
% Contiene la funcionalidad para separa los colores de una semilla de color
% variegado.
